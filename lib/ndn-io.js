...
ndn.globalKeyMangager = require('ndn-keyManager')

io.initFace = function(transportClass, portStreamOrWebSocket){
  io.face = new ndn.Face({host:1,port:1,getTransport: function(){return new transportClass.transport(portStreamOrWebSocket)}})
  io.face.transport.connect(io.face, function(){console.log("io face is connected to daemon")})
}
